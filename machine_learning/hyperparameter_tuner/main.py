...
from machine_learning.keras.model import basic_cnn_model_with_regularization
from machine_learning.train_simple import train_keras_model
...
google_automl_dataset = pd.read_csv( '/app/machine_learning/google_automl_cloud_and_shadow_dataset_small.csv')
...
band_stats = pd.read_csv('/app/machine_learning/cloud_and_shadow_stats_small_train.csv')
